package com.springboot.backend.victor.usersapp.users_backend.auth.filter;
...
import static com.springboot.backend.victor.usersapp.users_backend.auth.TokenJwtConfig.*;
...
public class JwtAuthFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        } catch (StreamReadException var6) {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
        ...
        body.put("message", String.format("Hola %s autenticado correctamente", username));
